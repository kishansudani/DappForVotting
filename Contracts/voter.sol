...
contract Voter is Ownable{
    ...
    function addVoter(address _address, string memory _addharCard, string memory _voterArea) public {
        _addVoter(_address, _addharCard, _voterArea);
    }
    
    function _addVoter(address _address, string memory _addharCard, string memory _voterArea) private  nonVoter(_address) onlyOwner() {
    ...
    function _removeVoter(address _address) private isVoter(_address) onlyOwner() {
